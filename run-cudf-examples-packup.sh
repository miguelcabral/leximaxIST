...
do	
    ...
    ./old_packup/packup -t --max-sat --leximax --external-solver '~/thesis/default-solver/RC2/bin/rc2.py -vv' "$f" 2>> "results/p_$(basename "$f")_tmp.out" >> "results/p_$(basename "$f")_tmp.out"
