...
/*******************************************************/
/* CUDF solver: agregate_combiner.h                    */
/* a concrete class for an agregate combiner           */
/* (c) Claude Michel I3S (UNSA-CNRS) 2009,2010,2011    */
/*******************************************************/


#ifndef __AGREGATE_COMBINER_H
#define __AGREGATE_COMBINER_H
...
class agregate_combiner: public abstract_combiner, public abstract_criteria {
 public:
  CriteriaList *criteria;   // set of criteria to agregate
  ...
  // agregate combiner creation
  agregate_combiner(CriteriaList *criteria) { this->lambda_crit = 1; this->criteria = criteria; };
  agregate_combiner(CriteriaList *criteria, CUDFcoefficient lambda_crit) { 
