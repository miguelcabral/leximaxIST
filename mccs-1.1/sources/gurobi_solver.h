...
/*******************************************************/
/* CUDF solver: gurobi_solver.h                        */
/* Concrete class for the Gurobi solver                */
/* (c) Claude Michel I3S (UNSA-CNRS) 2009,2010,2011    */
/*******************************************************/


// concrete class which implements an interface to GUROBI solver
...
#include <stdlib.h>
#include <stdio.h>
extern "C" { // required, otherwise it failed
#include <gurobi_c.h>
}

class gurobi_solver: public abstract_solver, public scoeff_solver<double, 0, 0> {
 public:
  ...
  double *gurobi_coeff; // cplex coefficients are doubles ...
