...
-o $SOLUTION /home/mcabral/thesis/old_packup/packup -u "$CRITERION" --max-sat --leximax \
--external-solver "$SOLVERCMD" $INSTANCE
    else
        /home/mcabral/runsolver/src/runsolver --vsize-limit 4000 -C 1200 -d 10 -w $STATS \
-o $SOLUTION /home/mcabral/thesis/old_packup/packup -u "$CRITERION" --leximax \
--external-solver "$SOLVERCMD" $INSTANCE
    fi
fi
